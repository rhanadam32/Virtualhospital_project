      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="index.php?riwayat_diagnosa" class="nav-link">
                <i class="nav-icon fas fa-book"></i>
                <p>
                  Daftar Laporan Pasien
                </p>
              </a>
            </li>
            <li class="nav-item">
              <a href="index.php?user1" class="nav-link">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          ...
          if (isset($_GET["user1"])) {
            include "user.php";
          } else if (isset($_GET["riwayat_diagnosa"])) {
            //tambah halaman transaksi yaa...~
            include "riwayat_diagnosa_admin.php";
          } else {
